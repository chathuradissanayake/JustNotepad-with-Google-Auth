    ...
    >
      ...
      <div className="px-3 md:px-4 py-2 md:py-2.5 bg-linear-to-r from-cyan-50 to-teal-50 border-t border-cyan-100 rounded-b-xl shrink-0">
        <div className="flex items-center justify-between">
          ...
          <p className="text-xs text-gray-500 truncate ml-4 max-w-[40%] text-right">
            <svg className="inline w-3 h-3 mr-1 align-text-bottom" fill="none" stroke="currentColor" viewBox="0 0 24 24">
